...
<html>
  ...
  <body>
      ...
      <div class="wxList">
            ...
            <a href="index/templatemsg/addTemplateTo">添加模板</a><br/>
            <a href="index/templatemsg/findTemplteToAll">模板消息管理</a><br/>
            <a href="index/templatemsg/findAllTemplte">推送消息</a><br/>
