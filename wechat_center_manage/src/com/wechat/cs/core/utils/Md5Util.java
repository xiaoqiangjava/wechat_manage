...
public class Md5Util {
	...
	public static void main(String[] args) {
		...
		System.out.println(Md5Util.toMD5("xwtechadmin"));

		String hashAlgorithmName = "MD5";
		String credentials = "123456";
		int hasIterators = 2;
		Object obj = new SimpleHash(hashAlgorithmName, credentials, ByteSource.Util.bytes("xwtechadmin"), hasIterators);
